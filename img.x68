...
rec:
;      image data encoded by img.py
;      each line (every 3 long words) is a rectangle
;      first long word indicates the fill color
;      second long word indicates the start X, Y coordinates (X << 16 | Y)
;      third long word indicates the end X, Y coordinates (X << 16 | Y)
;
;                 COLOR    strX|strY  endX|endY
